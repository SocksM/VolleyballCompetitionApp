...
namespace VolleyballCompetitionApp.Repository
{
	...
	{
		public int Create(ScoreDTO dto) // returns an int because the integer will be auto generated by the database so when you create the row you will be able to know what the id is
		...
		public void Update(ScoreDTO dto) // uses dto.id to dicate to what row it alters then alters that row
		{
